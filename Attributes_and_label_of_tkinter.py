...
my_Root.geometry("744x434")  #Width and Height of page
...
"""
title_label = Label(my_Root,text=""" A group of Germans at Allas Sea Pool, Helsinki, Finland. Traveling abroad together is a strong indicator of friendship.\n
...
bg="black",fg="Green",padx=23,pady=44,font="Ariel,15,bold",borderwidth=3,relief=SUNKEN)
...
title_label.pack(side= LEFT,padx=23,pady=33,fill=Y)
my_Root.mainloop()